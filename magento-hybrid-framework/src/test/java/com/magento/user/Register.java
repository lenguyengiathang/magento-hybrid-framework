...
public class Register extends BaseTest {
	...
	@Test(dependsOnMethods = "Register_14_Create_An_Account_Valid_Data", description = "Verify that user cannot create an account with an email belonging to another account")
