...
public class BasePageUI {
	...
	public static final String DYNAMIC_NAVIGATION_BAR_DROPDOWN_MULTI_LEVEL_ITEM_BY_LABEL = "xpath=(//span[text()='%s']/parent::a)[2]";
	...
	public static final String MINI_CART_BLOCK = "css=.block-minicart";
	...
	public static final String PROCEED_TO_CHECKOUT = "id=top-cart-btn-checkout";
