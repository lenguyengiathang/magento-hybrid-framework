...
public class ProductDetailsPageUI {
	...
	public static final String SIZE_REQUIRED_ERROR_MESSAGE = "css=.size div.mage-error";
	public static final String DYNAMIC_PRODUCT_COLOR_BUTTON_BY_LABEL = "xpath=//span[text()='Color']/following-sibling::div/div[@option-label='%s']";
	public static final String COLOR_REQUIRED_ERROR_MESSAGE = "css=.color div.mage-error";
	public static final String PRODUCT_QUANTITY_TEXTBOX = "id=qty";
	public static final String MAXIMUM_QUANTITY_ERROR_MESSAGE = "id=qty-error";
