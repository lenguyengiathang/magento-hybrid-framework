...
public class CheckoutPageUI {
	...
	public static final String ADDRESS_CARD_SHIP_HERE_BUTTON = "css=.action-select-shipping-item";
	...
	public static final String ADDRESS_DROPDOWN = "css=select[name='billing_address_id']";
