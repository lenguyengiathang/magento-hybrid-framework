...
public class ReviewOrderPageUI {
	...
	public static final String DYNAMIC_EDIT_ITEM_LINK_BY_SHIPPING_ADDRESS = "xpath=//address[contains(., '%s')]/ancestor::div[@class='box box-shipping-address']/following-sibling::div[2]//span[text()='Edit']/parent::a";
