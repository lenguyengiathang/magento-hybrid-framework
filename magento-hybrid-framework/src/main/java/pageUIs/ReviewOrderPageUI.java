...
public class ReviewOrderPageUI {
	...
	public static final String DYNAMIC_CHANGE_SHIPPING_ADDRESS_LINK_BY_PRODUCT_NAME = "//a[text()='%s']/ancestor::div[@class='block-content']//div[@class='box box-shipping-address']//a[@class='action edit']";
	public static final String DYNAMIC_CHANGE_SHIPPING_METHOD_LINK_BY_PRODUCT_NAME = "//a[text()='%s']/ancestor::div[@class='block-content']//div[@class='box box-shipping-method']//a[@class='action edit']";
