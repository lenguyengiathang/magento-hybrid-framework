...
public class ProductListingPageUI {
	...
	public static final String DYNAMIC_VIEW_TOGGLE_BUTTON_BY_VIEW_NAME = "xpath=(//a[@title='%s'])[1]";
	...
	public static final String SORT_BY_DROPDOWN = "id=sorter";
	...
	public static final String DYNAMIC_OVERALL_RATING_BY_PRODUCT_NAME = "xpath=//a[contains(text(),'%s')]/parent::strong/following-sibling::div/div[@class='rating-summary']/div";
	...
	public static final String NEXT_PAGE_BUTTON = "xpath=(//a[@title='Next'])[2]";
	public static final String LIMITER_DROPDOWN = "xpath=(//select[@id='limiter'])[2]";
}
